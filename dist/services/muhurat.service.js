...
class MuhuratService {
    ...
    static getMuhurats(sunrise, sunset, dateStr, lat, lon, tz = 'UTC') {
        ...
        const dt = luxon_1.DateTime.fromISO(`${dateStr}T12:00:00`, { zone: tz });
        ...
        const midnight = luxon_1.DateTime.fromISO(`${dateStr}T00:00:00`, { zone: tz });
...
exports.MuhuratService = MuhuratService;
